...
- **`docs_agent`** — has the `search_docs` tool from the flagship project ([projects/chat-with-your-docs](../../projects/chat-with-your-docs/)), for questions about the ingested documents
